...
class ErrorResponse(BaseModel):
    ...
    ErrorResponse
    """ # noqa: E501
    error: Optional[StrictStr] = Field(default=None, description="The error code used to identify what kind of error has occurred.")
    error_description: Optional[StrictStr] = Field(default=None, description="Human-Readable test providing additional information used to assist the client in understanding the error.")
